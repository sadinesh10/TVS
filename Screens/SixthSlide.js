...
function SixthSlide({ navigation }) {
  useEffect(() => {
  ...
  const [scannnedAsset, setScannedAsset] = useState(false);
  ...
  return (
    ...
    >
      ...
      <View style={{ marginTop: 18, flexDirection: "row" }}>
        ...
        <Modal visible={scannnedAsset} transparent={true}>
          <View
            style={{
              flex: 1,
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  Dispatch item has been scanned. Click Ok to add
                </Text>
              </View>
              <View
                style={{
